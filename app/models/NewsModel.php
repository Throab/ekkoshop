...
class NewsModel extends BaseModel
{
    ...
    function getAllNewAdmin()
    {
        return $this->db->table($this->tableName())->select('user.fullname, news.id, news.slug, news.title, news.content, news.thumb, news.create_at, news.view, news.status')->join('user', 'news.user_id = user.id')->get();
    }
