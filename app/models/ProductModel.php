...
class ProductModel extends BaseModel
{
    ...
    {
        $sql = "SELECT pv.id, pv.price, pv.quantity, pv.weight, pv.discount, p.title, a.id AS attribute_id, a.display_name, av.value_name AS attribute_value
        FROM product_variants pv
    ...
    {
        $sql = "SELECT pv.id, pv.price, pv.quantity, pv.discount, pv.weight, p.title, a.id AS attribute_id, a.display_name, av.value_name AS attribute_value
        FROM product_variants pv
        JOIN variants_value vv ON pv.id = vv.product_variant_id
        JOIN attribute a ON vv.attribute_id = a.id
        JOIN attribute_value av ON vv.attribute_value_id = av.id
