	                            ...
	                            <div class="checkout-coupon-total checkout-coupon-total-2 d-flex flex-wrap justify-content-end">
	                                <div class="checkout-total">
	                                    ...
	                                    <div class="single-total">
	                                        ...
	                                        <p class="price"><?= Format::formatCurrency($total_money - $dataOrder[0]['shipping_fee'] - $subtotal) ?></p>
	                                    </div>
	                                    <div class="single-total">
	                                        <p class="value">Phí giao hàng:</p>
	                                        <p class="price"><?= Format::formatCurrency($dataOrder[0]['shipping_fee']) ?></p>
	                                    </div>
