		...
		<div class="body d-flex py-3">
			<div class="container-xxl">
				<form method="post" enctype="multipart/form-data">
					...
					<div class="row align-items-center">
						<div class="border-0 mb-4">
							<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-end border-bottom flex-wrap">
								<!-- <h3 class="fw-bold mb-0">Cập nhập sản phẩm</h3> -->
								 <a href="admin/product" class="btn btn-warning btn-set-task w-sm-100 py-2 px-5 text-uppercase" style="margin-right: 10px;">
									Danh sách
								</a>
								<button type="submit" class="btn btn-primary btn-set-task w-sm-100 py-2 px-5 text-uppercase">Lưu lại</button>
							</div>
						</div>
					</div> <!-- Row end  -->
