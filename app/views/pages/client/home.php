                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center">
                                    <div class="ec-slide-content slider-animation">
                                        ...
                                        <h4 class="ec-slide-stitle"><?= $dataBannerItem['name'] ?></h4>
                                            ...
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="<?= $linkProduct ?>" class="image">
                                                        <!-- public/client/images/category-image/1.jpg -->
                                                        
                                                        <img class="main-image" src="<?= $dataProdMostViewItem['thumb'] ?>" 
                                                        title="<?= $dataProdMostViewItem['title'] ?>" 
                                                        alt="<?= $dataProdMostViewItem['title'] ?>" />
